// CookSync 인라인 SVG 아이콘 (CookSync.html 프로토타입과 동일한 패스).
// currentColor를 쓰므로 부모의 text-* 색이 적용된다.
...
// 썸네일 placeholder용 영상 글리프 (이미지 로드 실패/없을 때)
...
export function CameraOffIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2" />
      <path d="M9 3h6l2 3h4a2 2 0 0 1 2 2v7" />
